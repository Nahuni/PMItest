...
Sub mnuAdminPlayer_click()
    ...
    If Not Name = "Not Playing" Then
        ...
        Call PlayerMsg(FindPlayer(Name), "You have become a pokemon knight!", BrightCyan)
    End If
...
Sub mnuRemoveAdmin_click()
    ...
    If Not Name = "Not Playing" Then
        ...
        Call SendPlayerData(FindPlayer(Name))
        Call PlayerMsg(FindPlayer(Name), "Your powers were stripped away from you.", BrightRed)
    End If

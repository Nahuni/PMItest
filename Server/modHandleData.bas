    ...
    If Not IsPlaying(index) Then
        If Not IsLoggedIn(index) Then
            ...
            If buffer.ReadLong < CLIENT_MAJOR Or buffer.ReadLong < CLIENT_MINOR Or buffer.ReadLong < CLIENT_REVISION Then
                Call AlertMsg(index, "Version outdated, please visit spectrumbase.tk or my furaffinity for details " & Options.Website)
                Exit Sub
            End If
    ...
    If i >= 0 Or i <= 3 Then
        ...
        If n > 0 Then
            ...
            If GetPlayerAccess(n) <= 0 Then
                Call GlobalMsg(GetPlayerName(n) & ", Has become one of the islands deity's.", BrightBlue)
            End If

...
Public Const CLIENT_REVISION As Byte = 9
...
' ********************************************************
' General constants
Public Const MAX_PLAYERS As Long = 25
...
' server-side stuff
Public Const ITEM_SPAWN_TIME As Long = 2000 ' 20 seconds
...
Public Const ACCOUNT_LENGTH As Byte = 16

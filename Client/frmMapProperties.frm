...
Begin VB.Form frmEditor_MapProperties 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox CmbWeather 
         Height          =   315
         ItemData        =   "frmMapProperties.frx":030A
         Left            =   120
         List            =   "frmMapProperties.frx":0320
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmbSound 
         Height          =   315
         ItemData        =   "frmMapProperties.frx":034F
         Left            =   120
         List            =   "frmMapProperties.frx":0351
         Style           =   2  'Dropdown List
         TabIndex        =   40
         Top             =   360
         Width           =   1695
   ...
   Begin VB.Frame fraMapSettings 
      ...
      Begin VB.ComboBox cmbMoral 
         Height          =   315
         ItemData        =   "frmMapProperties.frx":0353
         Left            =   960
         List            =   "frmMapProperties.frx":035D
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   360
         Width           =   3135

...
Begin VB.Form frmEditor_Item 
   ...
   Begin VB.Frame fraEquipment 
      ...
      Begin VB.ComboBox cmbTool 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":030A
         Left            =   1320
         List            =   "frmEditor_Item.frx":031A
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbBind 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":033B
         Left            =   4200
         List            =   "frmEditor_Item.frx":0348
         Style           =   2  'Dropdown List
         TabIndex        =   24
         Top             =   600
         Width           =   1935
      ...
      Begin VB.ComboBox cmbType 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":0371
         Left            =   120
         List            =   "frmEditor_Item.frx":03A2
         Style           =   2  'Dropdown List
         TabIndex        =   21
         Top             =   1200
         Width           =   2655
